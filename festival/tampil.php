...
<?php		
		...
		while($data=$rs->fetch()){
			if($data->foto=='')
			{
				...
				$foto = "<img src='dbdemo/uploads/$data->foto'>";
			}
		?>
		<tr>
			...
			<td><a href="index.php?page=editmhs&nim=<?php echo $data->nim?>">Edit</a> | <a href="hapus.php?nim=<?php echo $data->nim?>&item=mhs">Delete</a></td>
		</tr>
		<?php
			$i++; 
		}
